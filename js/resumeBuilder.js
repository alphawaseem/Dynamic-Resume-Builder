...
let bio = {
    ...
    "display": function () {
        "use strict";
        this.showBioInfo();
        this.showContactInfo("topContacts");
        this.showContactInfo("footerContacts");
        this.showSkills();
    }
...
let education = {
    "schools": [{
        ...
        "degree": "12th grade",
        "dates": "2012-2014",
        "url": "http://www.stjosephassan.com",
    ...
    "showSchools": function () {
        ...
        this.schools.forEach(function (school) {  
            let name = HTMLschoolName.replace('%data%',school.name).replace('#',school.url);
